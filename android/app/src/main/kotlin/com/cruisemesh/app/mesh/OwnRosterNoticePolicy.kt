 ...
 */
internal object OwnRosterNoticePolicy {
     ...
     */
    val CAPABILITY_BIT: UInt = 1u shl 4
     ...
     */
    fun peerReadsNotices(peerCapabilities: UInt): Boolean =
        (peerCapabilities and CAPABILITY_BIT) != 0u
}
