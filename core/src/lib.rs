...
pub use protocol::{
    ...
    encode_introduced_friend_request, encode_lan_endpoint, encode_message_body,
    encode_message_body_with_reply, encode_profile_sync_content, encode_receipt_content,
    encode_transport_probe, generate_msg_id, parse_frame, verify_introduction_ticket,
    ExtendedMessageBody, Frame, FriendDirectoryContent, FriendDirectoryEntry,
