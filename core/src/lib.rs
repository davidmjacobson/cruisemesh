...
pub use store::{
    core_peer_transport_for_arrival, CarriedEnvelope, Contact, ContactDiscoveryPolicy,
    ContactProvenance, ContactRelayRejection, DigestEntry, FriendSuggestion, MessageArrival,
